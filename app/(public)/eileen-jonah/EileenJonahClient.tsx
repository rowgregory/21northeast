...
export function EileenJonahClient() {
      ...
      <div className="max-w-300 mx-auto w-full">
        <div className="max-w-3xl 990:max-w-247.5 xl:max-w-300 mx-auto w-full">
          ...
          <div className="mb-12 pb-8 border-b border-border-light dark:border-border-dark">
            ...
            <p className="text-base text-text2-light dark:text-text2-dark mt-3 max-w-lg">
              Serving the North Shore of Boston, Massachusetts — Swampscott, Lynn, Marblehead,
              Salem, Peabody, Beverly & Danvers
            </p>
          </div>
          ...
          <div className="grid grid-cols-12 gap-10 sm:gap-16">
            ...
            <div className="col-span-12 sm:col-span-4 xl:col-span-3">
              ...
              <div className="mt-8 pt-8 border-t border-border-light dark:border-border-dark">
                <p className="uppercase text-xs font-bold text-muted-light dark:text-muted-dark mb-4 tracking-wide">
                  Areas Served
                </p>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={town}
                      className="text-xs font-medium px-3 py-1.5 bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark text-text2-light dark:text-text2-dark"
                    >
                      {town}
                    </span>
                  ))}
