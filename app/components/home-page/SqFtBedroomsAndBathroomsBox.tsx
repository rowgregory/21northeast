    ...
    <div className="flex items-start sm:items-center justify-between gap-y-4  sm:gap-8 max-w-96 w-full flex-col sm:flex-row">
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col">
          <p className="text-zinc-700 font-bold text-sm leading-4">
            {sqft} SqFt
          </p>
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <div className="flex flex-col">
          <p className="text-zinc-700 font-bold leading-4 text-sm">
            {bedrooms}
          </p>
          <p className="text-zinc-500 font-normal leading-4 text-sm">
            Bedrooms
          </p>
        </div>
      </div>
