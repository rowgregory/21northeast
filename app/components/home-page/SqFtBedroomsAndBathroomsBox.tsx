  ...
  return (
    <div className="flex items-start md:items-center justify-between gap-y-4  sm:gap-8 w-full flex-col sm:flex-row">
      <div className="flex items-center gap-2">
        <DraftingCompass className={`${iconColor ?? 'text-zinc-700'} w-5 h-5 `} />
      ...
      <div className="flex items-center gap-2">
        <Bed className={`${iconColor ?? 'text-zinc-700'} w-5 h-5 `} />
        <div className="flex flex-col">
      ...
      <div className="flex items-center gap-2">
        <ShowerHead className={`${iconColor ?? 'text-zinc-700'} w-5 h-5 `} />
        <div className="flex flex-col">
